...
const playHitSound = (collision) => {
  // doesnt play sounds for less impact collisions
...
const tick = () => {
  ...
  // (a fixed time step, time passed since last step, how many iterations the world can apply to catch up with delay )
